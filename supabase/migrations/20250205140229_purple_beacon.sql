/*
  ...
  1. New Tables
    - transaction_rules: For automated categorization rules
    - transaction_patterns: For fraud detection patterns
    - financial_forecasts: For predictive analysis
    - document_extractions: For OCR and document analysis
    - tax_categorizations: For tax compliance rules

  2. Changes
    - Add AI-related columns to existing tables
    - Add new functions for AI processing
