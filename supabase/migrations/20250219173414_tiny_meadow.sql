...
BEGIN
  -- Delete existing bank accounts for this company
  ...
  INSERT INTO bank_accounts (
    ...
    (checking_id, target_company_id, 'ba_' || encode(gen_random_bytes(16), 'hex'),
     'checking', 'usd', 'active', '****1234', '021000021', 'Fleet Business Bank', 25000.00),
    (savings_id, target_company_id, 'ba_' || encode(gen_random_bytes(16), 'hex'),
     'savings', 'usd', 'active', '****5678', '021000021', 'Fleet Business Bank', 50000.00);
  ...
  -- Delete existing patterns and rules for this company
